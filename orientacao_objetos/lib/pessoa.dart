class Pessoa {
  ...
  Pessoa({String nome, int idade, String sexo, double altura, double peso}) {
  ...
  // Pessoa({this.nome, this.idade, this.sexo, this.altura, this.peso});
  ...
  // A setinha é uma forma de indicar o retorno da função
}
